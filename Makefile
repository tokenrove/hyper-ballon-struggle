...
DATAOBJS=archetype.o fontdat.o arenas.o instruments.o title-song.o in-game-song.o game-over-sting.o select-tune.o victory-sting.o sight-for-sore-thumbs.o to-be-developed.o
...
arenas.o: data/arena_default_mg.map data/arena_default_bg.map data/arena_vtube_mg.map data/arena_vtube_bg.map data/arena_lozenge_mg.map data/arena_lozenge_bg.map data/arena_gobacktospace_mg.map data/arena_gobacktospace_bg.map data/arena_iceblocks_mg.map data/arena_iceblocks_bg.map data/arena_gnmmine_mg.map data/arena_gnmmine_bg.map data/arena_maelstrom_mg.map data/arena_maelstrom_bg.map
